...
class RangeNode extends AbstractNode
{
	...
	{
		return CoreFuncs::GetRange( $this->getAbstractNode(0)->Execute( $provider, $dataPool ), $this->getAbstractNode(1)->Execute( $provider, $dataPool ) );
	}
