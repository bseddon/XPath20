...
/**
 * PrecedingSiblingNodeIterator (final)
 */
class PrecedingSiblingNodeIterator extends SequentialAxisNodeIterator implements \Iterator
{
	/**
	 * Constructor
	 */
	...
	{
		$result = new PrecedingSiblingNodeIterator();
