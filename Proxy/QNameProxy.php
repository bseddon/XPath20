 ...
 */
class QNameProxy extends ValueProxy implements IXmlSchemaType
{
	/**
	 * Value
	 * @var QNameValue $_value
	 */
	private $_value;
	...
	{
	    return $this->_value->NamespaceUri > $val->getValue()->NamespaceUri ||
	    	   ( $this->_value->NamespaceUri == $val->getValue()->NamespaceUri && $this->_value->LocalName > $val->getValue()->LocalName );
	}
	...
	{
	    return new QNameProxy( $val->getValue() );
	}
