...
/**
 * SByteProxy (internal final)
 */
class SByteProxy extends ValueProxy implements IXmlSchemaType
{
	public static $CLASSNAME = "lyquidity\XPath2\Proxy\SByteProxy";
	...
	{
	    return Integer::FromValue( floor( Convert::ToInt( $this->_value / Convert::ToSByte( $val->getValue() ) ) ) );
	}
	...
	public static function tests()
	{
		...
		$byte1 = new SByteProxy( 10 );
		$byte2 = new SByteProxy( 20 );
