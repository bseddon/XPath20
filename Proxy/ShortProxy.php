...
/**
 * Short (internal final)
 */
class ShortProxy extends ValueProxy implements IXmlSchemaType
{
	public static $CLASSNAME = "lyquidity\XPath2\Proxy\ShortProxy";
	...
	{
		return new ShortProxy( Convert::ToInt16( $val ) );
	}
	...
	{
		return Integer::FromValue( floor( Convert::ToInt( $this->_value /  Convert::ToInt16( $val->getValue() ) ) ) );
	}
	...
	public static function tests()
	{
		...
		$byte1 = new ShortProxy( 10 );
		$byte2 = new ShortProxy( 20 );
