...
class UIntProxy extends ValueProxy implements IXmlSchemaType
{
	...
	{
		return new UIntProxy( Convert::ToUInt32( $val->getValue() ) );
	}
	...
	{
		return new LongProxy( -$this->_value);
	}
	...
	{
		return new UIntProxy( $this->_value + $val->getValue() );
	}
	...
	{
		return Integer::FromValue( floor( Convert::ToUInt32( $this->_value /  Convert::ToUInt32( $val->getValue() ) ) ) );
	}
	...
	public static function tests()
	{
		...
		$byte1 = new UIntProxy( 10 );
		$byte2 = new UIntProxy( 20 );
