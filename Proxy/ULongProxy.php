...
/**
 * ULong (internal final)
 */
class ULongProxy extends ValueProxy implements IXmlSchemaType
{
	public static $CLASSNAME = "lyquidity\XPath2\Proxy\ULongProxy";
	...
	{
	    return new ULongProxy( Convert::ToUInt64( $val->getValue() ) );
	}
	...
	{
	    return new IntegerProxy( -$this->_value );
	}
	...
	{
	    return new IntegerProxy(  $this->_value + $val->getValue() );
	}
	...
	{
	    return Integer::FromValue( floor( $this->_value /  Convert::ToUInt64( $val->getValue() ) ) );
	}
	...
	public static function tests()
	{
		...
		$byte1 = new ULongProxy( 10 );
		$byte2 = new ULongProxy( 20 );
