...
/**
 * NormalizedStringValue (public)
 */
class NormalizedStringValue implements IXmlSchemaType
{
	/**
	 * Constructor
	 * @param array $value
	...
	{
		return XmlSchema::$NormalizedString;
	}
	...
	{
		if ( ! $obj instanceof NormalizedStringValue )
		{
			return false;
		}
